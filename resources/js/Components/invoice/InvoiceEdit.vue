...
let addItemToCart = (product) => {
    item.invoice_id = invoice.value.id;
    item.quantity = 1;
...
let onSave = () => {
    ...
    payload.append("id",invoice.value.id);
    ...
    axios.post("/api/update_invoice", payload);
    router.push("/invoice");
}
</script>
<template>
            ...
            <div class="card__content">
                <div class="card__content--header">
                    <div>
                        ...
                        <select name="" id="" class="input" v-if ="invoice.customer" v-model="invoice.customer_id">
                ...
                <div class="table">
                    ...
                    <!-- item 1 -->
                    <div class="table--items2" v-for="item in cart" :key="item.id">
...
<!--                            $ 10000-->
                        ...
                        <p style="color: red; font-size: 24px;cursor: pointer;" @click="removeItemFromCart(item)">
                            &times;
                        </p>
                    </div>
